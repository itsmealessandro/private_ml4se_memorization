...
## Run Info
- Timestamp (UTC): 2026-02-05T15:07:33.391786Z
...
- One-line rationale: Similarity is close to background (margin=-0.023) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0943
...
- Background similarity (generated baseline): 0.1636
- Similarity margin vs background (avg_original - background_ref): -0.0229
- Avg MinHash similarity (perturbed): 0.0723
- Avg robustness drop (original - perturbed): 0.0221
...
## Files Produced
- results.json: results_colab_llama_n50.json (machine-readable)
