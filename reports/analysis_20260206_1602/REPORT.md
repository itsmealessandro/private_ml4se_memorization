...
## Run Info
- Timestamp (UTC): 2026-02-06T15:18:46.896130Z
...
- One-line rationale: Similarity is close to background (margin=-0.269) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.1738
- Exact match rate (original): 0.00%  (exact_matches=0/5)
- High similarity rate @0.7: 0.00%
- Background similarity (reference baseline): 0.4424
- Background similarity (generated baseline): 0.4863
- Similarity margin vs background (avg_original - background_ref): -0.2687
- Avg MinHash similarity (perturbed): 0.1728
- Avg robustness drop (original - perturbed): 0.0010
...
## Files Produced
- results.json: results_mistral_n5_colab.json (machine-readable)
