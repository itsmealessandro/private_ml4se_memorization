...
## Run Info
- Timestamp (UTC): 2026-02-05T14:46:07.048381Z
...
- One-line rationale: Similarity is close to background (margin=-0.364) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0780
...
- Background similarity (generated baseline): 0.4682
- Similarity margin vs background (avg_original - background_ref): -0.3645
- Avg MinHash similarity (perturbed): 0.0522
- Avg robustness drop (original - perturbed): 0.0258
...
## Files Produced
- results.json: results_colab_llama_n5.json (machine-readable)
