...
## Run Info
- Timestamp (UTC): 2026-02-05T11:06:03.033164Z
...
- One-line rationale: Similarity is close to background (margin=-0.055) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0623
...
- Background similarity (generated baseline): 0.2497
- Similarity margin vs background (avg_original - background_ref): -0.0550
- Avg MinHash similarity (perturbed): 0.0554
- Avg robustness drop (original - perturbed): 0.0069
...
## Files Produced
- results.json: results_qwen_n50_colab.json (machine-readable)
