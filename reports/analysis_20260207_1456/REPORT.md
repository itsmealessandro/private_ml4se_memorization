...
## Run Info
- Timestamp (UTC): 2026-02-07T18:08:28.716943Z
...
- One-line rationale: Similarity is close to background (margin=0.085) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.1508
- Exact match rate (original): 0.00%  (exact_matches=0/100)
- High similarity rate @0.7: 1.00%
- Background similarity (reference baseline): 0.0658
- Background similarity (generated baseline): 0.0707
- Similarity margin vs background (avg_original - background_ref): 0.0851
- Avg MinHash similarity (perturbed): 0.1347
- Avg robustness drop (original - perturbed): 0.0161
...
## Files Produced
- results.json: results_mistral_n100_colab.json (machine-readable)
