...
## Run Info
- Timestamp (UTC): 2026-02-05T15:50:52.070840Z
...
- One-line rationale: Similarity is close to background (margin=0.027) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0923
...
- Background similarity (generated baseline): 0.1161
- Similarity margin vs background (avg_original - background_ref): 0.0265
- Avg MinHash similarity (perturbed): 0.0820
- Avg robustness drop (original - perturbed): 0.0103
...
## Files Produced
- results.json: results_colab_llama_n100.json (machine-readable)
