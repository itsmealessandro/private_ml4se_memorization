...
## Run Info
- Timestamp (UTC): 2026-02-06T17:29:45.373908Z
...
- One-line rationale: Similarity is close to background (margin=0.030) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.1475
- Exact match rate (original): 0.00%  (exact_matches=0/50)
- High similarity rate @0.7: 0.00%
- Background similarity (reference baseline): 0.1172
- Background similarity (generated baseline): 0.1213
- Similarity margin vs background (avg_original - background_ref): 0.0303
- Avg MinHash similarity (perturbed): 0.1375
- Avg robustness drop (original - perturbed): 0.0101
...
## Files Produced
- results.json: results_mistral_n50_colab.json (machine-readable)
