...
## Run Info
- Timestamp (UTC): 2026-02-05T09:39:15.336073Z
...
- One-line rationale: Similarity is close to background (margin=-0.391) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0515
...
- Background similarity (generated baseline): 0.4369
- Similarity margin vs background (avg_original - background_ref): -0.3910
- Avg MinHash similarity (perturbed): 0.0498
- Avg robustness drop (original - perturbed): 0.0017
...
## Files Produced
- results.json: results_qwen_n5_colab.json (machine-readable)
