...
## Run Info
- Timestamp (UTC): 2026-02-05T13:58:59.257726Z
...
- One-line rationale: Similarity is close to background (margin=-0.006) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0598
...
- Background similarity (generated baseline): 0.1840
- Similarity margin vs background (avg_original - background_ref): -0.0059
- Avg MinHash similarity (perturbed): 0.0512
- Avg robustness drop (original - perturbed): 0.0087
...
## Files Produced
- results.json: results_qwen_n100_colab.json (machine-readable)
