...
## Run Info
- Timestamp (UTC): 2026-01-14T15:34:19.044470Z
...
- One-line rationale: Similarity is close to background (margin=-0.290) and exact-match rate is low (0.0%).

## Key Metrics
- Avg MinHash similarity (original): 0.0812
- Exact match rate (original): 0.00%  (exact_matches=0/3)
- High similarity rate @0.7: 0.00%
- Background similarity (reference baseline): 0.3716
- Background similarity (generated baseline): 0.3441
- Similarity margin vs background (avg_original - background_ref): -0.2904
- Avg MinHash similarity (perturbed): 0.0612
- Avg robustness drop (original - perturbed): 0.0200
